...
@Entity
public class durgaprasadVillage {
    @Id
    ...
    public durgaprasadVillage(){}
    public durgaprasadVillage(int villageId, String villageName, int numOfMen, int numOfWomen, int villagePopulation,
            int numOfSchools) {
