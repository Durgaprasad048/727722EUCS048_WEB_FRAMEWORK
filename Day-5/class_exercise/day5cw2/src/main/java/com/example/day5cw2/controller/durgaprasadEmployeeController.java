...
import com.example.day5cw2.service.durgaprasadEmployeeService;
...
public class durgaprasadEmployeeController {
    ...
    public ResponseEntity<durgaprasadEmployee> putMethodName(@PathVariable("employeeId") int id, @RequestBody durgaprasadEmployee employee) {
    ...
    public ResponseEntity<durgaprasadEmployee> delete(@PathVariable("employeeId") int id,@RequestBody durgaprasadEmployee employee)
    {
