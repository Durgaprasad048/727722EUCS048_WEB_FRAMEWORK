...
@Entity
public class durgaprasadCourse {
     ...
     public durgaprasadCourse() {

     }

     public durgaprasadCourse(int courseId, String courseName, int creditHours, String instructor, String preRequistes,
